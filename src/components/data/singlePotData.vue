...
<template>
    <div class="p-6 py-12 flex flex-col justify-between gap-4 rounded-xl shadow-sm border" :class="[props.DataTemp > 25 && props.DataHum < 50 ? 'border-rose-600 border-2' : 'border-zinc-200 border']">
        <div class="flex gap-4 items-center justify-center w-full">
            <div class="text-center">
                <p class="text-zinc-800 text-xl font-semibold">{{ props.Label }}</p>
                <p class="text-zinc-800 text-xs md:text-base font-base">Status :
